...
import { EMAIL_QUEUE_PREFIX, SENDGRID_EMAIL } from '@shared/constants';
import { CommunicationQueueMessage, EmailParams, EmailResponse } from '@shared/types';
...
export async function sendUser2FASetupEmail(options: User2FASetupEmailOptions, env: Env): Promise<EmailResponse> {
...
export async function sendUser2FADisabledEmail(options: User2FADisabledEmailOptions,  env: Env): Promise<EmailResponse> {
