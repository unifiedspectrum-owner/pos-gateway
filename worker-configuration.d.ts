/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 625c85b22e0c7ccbfeb9dcfb9ef3dab6)
// Runtime types generated with workerd@1.20250917.0 2025-10-04 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		POS_DB_GLOBAL: D1Database;
		JWT_AUTH_SECRET: SecretsStoreSecret;
		JWT_GATEWAY_SECRET: SecretsStoreSecret;
		TWILIO_ACCOUNT_SID: SecretsStoreSecret;
		TWILIO_AUTH_TOKEN: SecretsStoreSecret;
		SENDGRID_API_KEY: SecretsStoreSecret;
		POS_BACKEND: Fetcher /* pos-backend */;
		ASSETS: Fetcher;
	}
}
